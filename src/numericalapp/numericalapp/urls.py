...
from Interpolation.views import vandermonde_view, newtondivdif_view, lagrange_view, neville_view, splines_view
...
urlpatterns = [
    ...
    path("splines/", splines_view, name="splines.index"),
